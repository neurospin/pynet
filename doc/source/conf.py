...
cmd = ["sphinxdoc", "-v 2", "-p",  installdir, "-n", "pynet", "-o", "..",
       "-m", "-i", "python-network"] + MOCK_MODULES + ["matplotlib",
       "matplotlib.pyplot", "-r", "object", "object", "object", "object",
       "object", "-k", "Module", "VGG", "ResNet", "DenseNet", "Inception3"]
...
sphinx_gallery_conf = {
    "doc_module": "pynet",
    "backreferences_dir": os.path.join("pynet", "gallery"),
...
project = u"pynet"
copyright = u"""2019, pynet developers <antoine.grigis@cea.fr>"""
...
# [howto/manual]).
latex_documents = [
    ("index", "pynet.tex", "pynet Documentation", """pynet developers""",
     "manual"),
]
